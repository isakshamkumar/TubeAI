...
export default function Extension() {
  ...
  return (
    <main
      ...
      className={`antialiased w-full mb-3 z-10 ${`dark`}`}>
      <div className="w-full">
        <Collapsible
          ...
          className="space-y-3">
          <ExtensionActions />
          <CollapsibleContent className="w-full h-fit max-h-[500px] border bg-white border-zinc-200 rounded-md overflow-auto ">
            <ExtensionPanels />
          </CollapsibleContent>
        </Collapsible>
      </div>
